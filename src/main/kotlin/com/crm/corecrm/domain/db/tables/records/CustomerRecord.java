...
public class CustomerRecord extends UpdatableRecordImpl<CustomerRecord> implements Record5<Integer, Long, String, String, String> {

    private static final long serialVersionUID = -705929788;
     ...
     */
    @Override
    public CustomerRecord values(Integer value1, Long value2, String value3, String value4, String value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CustomerRecord(Integer id, Long tgId, String firstname, String lastname, String username) {
        super(Customer.CUSTOMER);
